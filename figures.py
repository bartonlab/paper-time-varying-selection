...
def plot_simple(**pdata):
    ...
    if savepdf==True:
        ...
        plt.savefig('%s/%s/%s.pdf' % (FIG_DIR,sim_dir,name), facecolor = fig.get_facecolor(), edgecolor=None, **FIGPROPS)
...
def plot_simple_constant(**pdata):
    ...
    if savepdf==True:
        ...
        plt.savefig('%s/%s-alltv/%s.pdf' % (FIG_DIR,filename,name), facecolor = fig.get_facecolor(), edgecolor=None, **FIGPROPS)
...
def plot_epitopes(**pdata):
    ...
    tc_sample_ex = FData.sc_sample_ex  # selection coefficients for sample time points
    tc_all_ex    = FData.sc_all_ex     # selection coefficients for all time points
